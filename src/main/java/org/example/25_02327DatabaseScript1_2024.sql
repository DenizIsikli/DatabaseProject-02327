...
('COVID-19', '2020-01-01', 3001),
('Politik', '2020-01-01', 3002),
('Sport', '2020-01-01', 3003),
('Kultur', '2020-01-01', 3004),
('Infrastruktur', '2020-01-01', 3005),
('Debat', '2020-01-01', 3006),
('Metro', '2020-01-01', 3007),
('Superliga', '2020-01-01', 3008),
('TV2', '2020-01-01', 3009),
('Yousee', '2020-01-01', 3010);
...
-- Insert into Article
INSERT INTO Article (Title, Text, Topic, Times_read, Journalist_CPR) VALUES
('COVID-19', 'CODID-19 dødsfald', 'Nyheder', 537, 3001),
('Politik Venstre', 'Ny regering', 'Politik', 1541, 3002),
('Superliga', 'Fodbold', 'Sport', 492, 3003),
('Kultur', 'Ny film', 'Kultur', 1782, 3004),
('COVID-19 vaccine', 'Mulig vaccine', 'Nyheder', 231, 3005),
('Amerikansk fodbold', 'Jets V Packers', 'Sport', 731, 3006),
('TV2', 'Klovn', 'TV', 382, 3007),
('COVID-19 smittetal', 'Smittetal for 2021', 'Nyheder', 85, 3008),
('Tennis', 'Tennis', 'Sport', 1255, 3009),
('Yousee', 'Ny serie', 'Kultur', 3446, 3010),
('Storm', 'Storm børge', 'Nyheder', 133, 3011),
('BIF v FCK', 'Fodbold derby', 'Sport', 7342, 3012),
('Teater', 'Ny teaterstykke', 'Kultur', 1377, 3013),
('Malaria', 'Mugig vaccine', 'Nyheder', 361, 3014),
('OL', '100M løb', 'Sport', 746, 3015),
('Kanye West', 'Store vega', 'Kultur', 25, 3016),
('COVID-19 Mutation', 'COVID-19 mutation', 'Nyheder', 842, 3017),
('Golf', 'Tiger Woods', 'Sport', 8932, 3018),
('Dune Part 2', 'Ny film', 'Kultur', 935, 3019),
('Ebola', 'Ethiopia', 'Nyheder', 152, 3020);
